...
function BeerInformation(props: BeerInformationProps) {
    ...
    return (
        <div className='grid lg:grid-rows-2 grid-flow-row lg:grid-flow-col w-full'>
            ...
            <div className='lg:mb-[100px] order-3 lg:order-2 lg:col-span-2 space-y-8 py-10 lg:pb-0 lg:pt-12 lg:mx-0 px-5 lg:px-0 w-[-moz-available]  w-[-webkit-fill-available] w-[-fill-available] rounded-t-xl lg:max-w-[32rem] mx-[-20px]'>
            </div>
